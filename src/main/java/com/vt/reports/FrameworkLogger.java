...
import com.vt.enums.LogType;
import com.vt.utilities.PropertyUtils;
import com.vt.utilities.ScreenShortUtils;
...
public final class FrameworkLogger {
    ...
    private static final Consumer<String> TAKESCREENSHOT = (message)-> ExtentManager.getExtentTest().info("",
            MediaEntityBuilder.createScreenCaptureFromBase64String(ScreenShortUtils.getBase64Image()).build());
    ...
    static {
        ...
        MAP.put(LogType.WARNING, WARNING);
